...
<form action="{{ route('contrato.store') }}" method="post">
    ...
    <section class="d-flex justify-content-center">
        <div class="card m-5" style="width: 65vw;">
            ...
            <div class="mb-3 mx-5">
                <select name="lancamento_categoria_id" class="form-select">
                    <option disabled selected>Categoria de lançamento</option>
                    @foreach ($lancamentos_categoria as $lancamento_categoria)
                        <option value="{{ $lancamento_categoria->lancamento_categoria_id }}">
            ...
            <div class="mb-3 mx-5">
                <select name="conta_id" class="form-select">
                    ...
                    @foreach ($contas as $conta)
                        <option value="{{ $conta->conta_id }}">{{ $conta->cta_nome_cedente }}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3 mx-5">
                <select name="centro_custo_id" class="form-select">
                    ...
                    @foreach ($centros_custo as $centro_custo)
                        <option value="{{ $centro_custo->centro_custo_id }}">{{ $centro_custo->cec_nome }}</option>
                    @endforeach
                </select>
            </div>
            <hr>
            ...
            <div class="form-check d-flex mx-4">
                ...
                <div>
                    ...
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_enviar_email" type="checkbox"
                ...
                <div>
                    ...
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_enviar_aviso" type="checkbox"
                ...
                <div>
                    ...
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_enviar_atraso" type="checkbox"
            ...
            <div class="form-check d-flex mx-4">
                ...
                <div>
                    ...
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_enviar_cobranca_wpp" type="checkbox"
                ...
                <div>
                    ...
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_enviar_aviso_wpp" type="checkbox"
            ...
            <div class="form-check d-flex mx-3">
                <div>
                    ...
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_ativo" type="checkbox" id="contrato_ativo"
                        checked="checked">
                    <label class="form-check-label" for="contrato_ativo">Contrato ativo</label>
                </div>
                <div>
                    <input type="hidden" name="ctr_pix" value="n">
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_pix" type="checkbox" id="ctr_pix"
                        checked="checked">
                    <label class="form-check-label" for="ctr_pix">Aceitar Pix (1% taxa + R$ 0,50)</label>
                </div>
                <div>
                    <input type="hidden" name="ctr_boleto" value="n">
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_boleto" type="checkbox" id="ctr_boleto"
                        checked="checked">
                    <label class="form-check-label" for="ctr_boleto">Aceitar Boleto</label>
                </div>
                <div>
                    <input type="hidden" name="ctr_cartao" value="n">
                    <input class="ms-2 form-check-input me-2" value="s" name="ctr_cartao" type="checkbox" id="acc_cartao">
                    ...
                    <div id="qtd_parcelas">
                        ...
                        <div>
                            <select class="form-select" name="ctr_qtd_parcelas" title="Parcelamento">
                ...
                <div class="m-3 mx-5">
                    ...
                    <div class="d-flex">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" name="ctr_emitir_nfse_antes_quitacao" value="S"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="ctr_emitir_nfse_antes_quitacao" value="N"
